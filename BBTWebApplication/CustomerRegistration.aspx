<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerRegistration.aspx.cs" Inherits="BBTWebApplication.CustomerRegistration" %>
...
<body style="background-color: #FFE7B3; text-align: center; padding-top: 150px; font-family: arial;">
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="BBT New Customer Registration"></asp:Label>
            <br />
            <br />
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;<asp:Button ID="submitButton" runat="server" Text="Submit" Width="200px" BackColor="#E6FAFF" OnClick="submitButton_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            <br />
